...
| ⚙️ **Custom Titlebar** | Draggable window with integrated controls |
| 🎬 **Media Previews** | Watch trailers and view screenshots |
| 💾 **One-Click Install** | Easy game installation |
| 🔁 **Steam Restart** | Prompt to restart Steam after installing |
---
## 📥 Download
### Latest Release: v0.2.3
👉 **[Download from Releases](https://github.com/sushi-dev55/Sushi-Launcher/releases)**
> ⚠️ **Note:** Download the `.exe` file from the Releases page, not the source code!
---
## 🎬 Tutorial
...
---
## 🛠️ Tech Stack
- 🦀 **Tauri** - Cross-platform desktop app (Rust backend)
- ⚛️ **React 18** - UI framework
- 🎨 **Tailwind CSS** - Styling
- ⚡ **Vite** - Build tool
- 🎮 **Steam API** - Game data and metadata
---
## 💬 Community
